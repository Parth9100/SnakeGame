	...
	while (WindowShouldClose() == false) {
		...
		switch (currentState) {
			...
			case PLAYING: {
				...
				DrawText("Retro Snake", offSet - 5, 20, 40, mediumGreen);
				DrawText(TextFormat("Score: %i", game.score), offSet - 5, offSet + cellSize * cellCount + 10, 40, mediumGreen);
				game.Draw();
